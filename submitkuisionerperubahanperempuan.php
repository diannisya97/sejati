...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO kuisionerperubahanperempuan (idusersiswa, q1, q2, q3, q4, q5, q6, q7, q8, q9, totalSkor, kategori)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    if ($stmt = mysqli_prepare($conn, $sql)) {
        // Correct type definition string to match the number of variables
        mysqli_stmt_bind_param($stmt, "iiiiiiiiiiis", 
            $idusersiswa, $q1, $q2, $q3, $q4, $q5, $q6, $q7, $q8, $q9, $totalSkor, $kategori);
